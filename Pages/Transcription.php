<?php 
	...
	?>
		...
		<div class="row">
			...
			<div class="col-sm-7">
				<!-- TODO : Changer la taille de l'image en fonction de la taille de l'ecran -->
			...
			<div class="col-sm-5">
				<!-- TODO : Subdiviser la colonne de façon plus agréable pour mettre les différentes cases du formualaire-->
				...
				<div class="form-group"> 
					<div class="col-sm-offset-2 col-sm-10">
						...
						<!-- TODO : Bouton pour changer le formulaire en textarea (en GET) -->
					</div>
				</div>
			</form>
			</p>
